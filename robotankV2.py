        ...
        for event in pygame.event.get():
            if event.type == pygame.QUIT or (event.type == pygame.KEYDOWN and event.key == pygame.K_q):
                ...
                if event.key == pygame.K_w:
                    ...
                    stationary = True
                elif event.key == pygame.K_UP and servo2.value < 0.9:
                    servo2.value += 0.1
                elif event.key == pygame.K_DOWN and servo2.value > -0.9:
                    servo2.value -= 0.1
                elif event.key == pygame.K_LEFT and servo1.value < 0.9:
                    servo1.value += 0.1
                elif event.key == pygame.K_RIGHT and servo1.value > -0.9:
                    servo1.value -= 0.1
